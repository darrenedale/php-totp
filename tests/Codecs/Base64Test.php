...
final class Base64Test extends TestCase
{
    ...
    /** Ensure we can construct a Base64 codec instance with some raw data. */
	...
	{
        $base64 = new Base64();
        $base64->setRaw($plainData);
        $this->assertSame($plainData, $base64->raw());
	}

    /** Data provider with valid base32-encoded data for testSetEncoded1() .*/
    public static function providerTestSetEncoded1(): iterable
	{
        yield "typical-ascii-data" => ["dGVzdC1kYXRhLXRvLWVuY29kZQ==",];
        yield "typical-mixed-data" => ["dGVzdC3/LW1peGVkLYAtZGF0YS0ALXRvLY8tZW5jb2RlCgo=",];
        yield "typical-binary-data" => ["//79/Pv6+Pc=",];
    ...
    {
        yield "invalid-ascii-string" => ["dGVzdC1kYXRhLXRvLWVuY29kZ_==",];
        yield "invalid-binary-data" => ["\xff\xfe\xfd\xfc\xfb\xfa\xf8\xf7",];
        yield "invalid-mixed-data" => ["dGVzdC3/LW1peGVkLYAtZGF0YS0ALXRvLY8tZW5jb2RlCg_=",];
        yield "invalid-png-data" => [
    ...
    /** Ensure setting base64-encoded data with invalid characters throws the expected exception. */
    ...
    public function testSetEncoded2(mixed $encodedData): void
    {
        ...
        $this->expectExceptionMessageMatches("/^Invalid base64 character found at position \\d+$/");
        (new Base64())->setEncoded($encodedData);
    }

    /** Provides "base64-encoded" strings with invalid amounts of = padding for testSetEncoded3(). */
    public static function providerTestSetEncoded3(): iterable
    {
        yield "padded-with-3" => ["\x00\x00\x00\x00\x00==="];
    }

    /** Ensure setting base64-encoded data with incorrect padding throws the expected exception. */
    #[DataProvider("providerTestSetEncoded3")]
    public function testSetEncoded3(string $encoded): void
    {
        $this->expectException(InvalidBase64DataException::class);
        $this->expectExceptionMessage("Base64 data must be padded with either 0, 1 or 2 '=' characters");
        (new Base64())->setEncoded($encoded);
    }

    /** Provides "base64-encoded" strings with incorrect lengths for testSetEncoded4(). */
    public static function providerTestSetEncoded4(): iterable
    {
        yield "1-extra-character" => ["dGVzdC1kYXRhLXRvL"];
        yield "2-extra-characters" => ["dGVzdC1kYXRhLXRvLW"];
        yield "3-extra-characters" => ["dGVzdC1kYXRhLXRvLWV"];
    }

    /** Ensure setting ba6432-encoded data with incorrect length throws the expected exception. */
    #[DataProvider("providerTestSetEncoded4")]
    public function testSetEncoded4(string $encoded): void
    {
        $this->expectException(InvalidBase64DataException::class);
        $this->expectExceptionMessage("Base64 data must be padded to a multiple of 4 bytes");
        (new Base64())->setEncoded($encoded);
    }

    /** Data provider with raw data and the base64-encoded equivalent for testEncoded1() and testEncode1(). */
    public static function providerRawAndEncoded(): iterable
	{
        yield "typical-ascii-data" => ["test-data-to-encode", "dGVzdC1kYXRhLXRvLWVuY29kZQ==",];
        yield "typical-mixed-data" => ["test-\xff-mixed-\x80-data-\x00-to-\x8f-encode\n\n", "dGVzdC3/LW1peGVkLYAtZGF0YS0ALXRvLY8tZW5jb2RlCgo=",];
        yield "typical-binary-data" => ["\xff\xfe\xfd\xfc\xfb\xfa\xf8\xf7", "//79/Pv6+Pc=",];
        yield "typical-png-image-data" => [
	...
	{
        $this->assertSame($expectedEncodedData, (new Base64($plainData))->encoded(), "Base64::encoded() produced unexpected output");
	}
    ...
    {
        $this->assertSame($expectedEncodedData, Base64::encode($plainData), "static Base64::encode() produced unexpected output");
    }
	...
	{
        yield "typicalAsciiData" => ["dGVzdC1kYXRhLXRvLWVuY29kZQ==", "test-data-to-encode",];
        yield "typicalMixedData" => ["dGVzdC3/LW1peGVkLYAtZGF0YS0ALXRvLY8tZW5jb2RlCgo=", "test-\xff-mixed-\x80-data-\x00-to-\x8f-encode\n\n",];
        yield "typicalBinaryData" => ["//79/Pv6+Pc=", "\xff\xfe\xfd\xfc\xfb\xfa\xf8\xf7",];
        yield "typicalPNGImageData" => [
            "",
            "",
        ];
        yield "extremeEmptyData" => ["", "",];
	}
    ...
    public function testRaw1(string $encodedData, string $expectedRawData)
	{
        ...
        $this->assertSame($expectedRawData, $base64Codec->raw(), "Base64::raw() produced unexpected output");
	}
    ...
    {
        $this->assertSame($expectedRawData, Base64::decode($encodedData), "static Base64::decode() produced unexpected output");
    }

    /** Data provider with non-strict base64-encoded strings and the decoded content for testRaw2() and testDecode2(). */
    public static function providerRelaxedValidEncodedData(): iterable
    {
        yield "ascii-without-padding" => ["dGVzdC1kYXRhLXRvLWVuY29kZQ", "test-data-to-encode",];
    }
    ...
    {
        Base64::setStrict(false);
        $base32Codec = new Base64();
        $base32Codec->setEncoded($encodedData);

        self::assertSame($expectedRawData, $base32Codec->raw(), "Base64::raw() produced unexpected output");
    }
    ...
    {
        Base64::setStrict(false);
        self::assertSame($expectedRawData, Base64::decode($encodedData), "static Base64::decode() produced unexpected output");
    }
}
